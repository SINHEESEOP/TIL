...
### 6.3 언어별 인터페이스와 서버 비교

다음 표는 주요 프로그래밍 언어마다 웹 요청 처리를 위한 인터페이스와 서버를 비교합니다:
...
결국 "자바의 서블릿 컨테이너, 파이썬의 WSGI 서버, Node.js의 http 모듈" 모두, 'HTTP를 받아서 개발자 로직을 호출'하는 동일 목적을 달성하려고 다른 구현을 제공하는 것입니다.
